...
if i == 2 and k == 1:
	subprocess.call('rm file; echo 80 >> file; /usr/bin/python3.5 main.py', shell=True)
elif i == 1 and k == 1:
	subprocess.call('rm file; echo 100 >> file; /usr/bin/python3.5 main.py', shell=True)
elif i == 0 and k == 1:
	subprocess.call('rm file; echo 120 >> file; /usr/bin/python3.5 main.py', shell=True)
